...
<section class="engine"><a href="">bootstrap table</a></section><section class="features3 cid-qKc8EbLvNX" id="features3-2b" data-rv-view="191">
    <form method="post" action="fireemp1.php">
        <div style="padding-left: 500px">
            ...
            <input type="Submit" name="submit" value="Remove" style="font-size: 30px;border-radius: 5px 5px 5px 5px;border-width: 1px;border-style: solid; background-color: green; cursor: pointer; color: white"></input>
