<?php
    ...
    $sql = "select * from rideinfo where driverstatus=1 and given='0'";
    ...
    $sql1 = "select * from driverstatus where status = 0";
...
<head>
  ...
  <title>Appoint Driver for Ride</title>
...
<section class="engine"><a href="">bootstrap table</a></section><section class="features3 cid-qKc8EbLvNX" id="features3-2b" data-rv-view="191">
    <form action="appoint.php" method="post">
        <div style="padding-left: 500px">
            ...
            <label style="font-size: 30px">Driver Mail:</label>
            <input type="text" name="drivermail" style="font-size: 19px; width: 300px; border-radius: 5px 5px 5px 5px;border-width: 1px;border-style: solid"></input><br>
            <input type="Submit" name="submit" value="Assign" style="font-size: 30px;border-radius: 5px 5px 5px 5px;border-width: 1px;border-style: solid; background-color: green; cursor: pointer; color: white"></input>
    ...
    <form action="changestatus.php" method="post">
        <div style="padding-left: 500px">
            <label style="font-size: 30px">Driver Mail:</label>
            <input type="text" name="drivermail" style="font-size: 19px; width: 300px; border-radius: 5px 5px 5px 5px;border-width: 1px;border-style: solid"></input><br>
            <input type="Submit" name="submit" value="Change Status" style="font-size: 30px;border-radius: 5px 5px 5px 5px;border-width: 1px;border-style: solid; background-color: green; cursor: pointer; color: white"></input>

        </div>        
    </form>
    <br><br>
    <h2>List Of User To Whom Driver needs to be assigned</h2>
  ...
  <br><br>
    <h2>List Of Drivers Who are free:</h2>
    <table class="data-table">
